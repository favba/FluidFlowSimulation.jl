...
const sim_par = (:Lx,:Ly,:Lz,:Nx,:Ny,:Nz,:Lcs,:Lcv,:Nrx,:Lrs,:Lrv,:ν,:VelocityTimeStepType,:PassiveScalarType,:DensityStratificationType,:LESModelType,:ForcingType,:Dealias,:Kxr,:Kyr,:Kzr,:kx,:ky,:kz,:Thr,:RealRanges)
