function writeoutput(s::AbstractSimulation,init::Integer)
    ...
    if haspassivescalar(s)
        copyto!(s.passivescalar.ρrhs.field.data, s.passivescalar.ρ.field.data)
        irfft!(s.passivescalar.ρrhs)
        write("scalar.$init",s.passivescalar.ρrhs)
        dealias!(s.passivescalar.ρrhs)
    end
    if hasdensity(s)
        copyto!(s.densitystratification.ρrhs.field.data,s.densitystratification.ρ.field.data)
